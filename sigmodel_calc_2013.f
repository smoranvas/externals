...
C       Declare arguments.
	...
	integer         zpass,apass
	logical		modelhack
	real*8          ff1,deltae,e1cc,e2cc,aux(7) ! added by smoran
	real*8          dum0,dum1,dum2,dum3,dum4,dum5
C       Declare locals.
...
CDG	   sig_dis = sig_dis*inelastic_it(x,A)
	   write(6,*) 'IN part: ',  sig_dis, sigmott
	endif


CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                            
CCCCCCCCCCCCCCCCCCCCCC  F1F2QE09 CASE   CCCCCCCCCCCCCCCCCCCCCCCCC

                                                                                             
       if((xflag.eq.1).or.(xflag.eq.2)) then                                                  
C          PRINT *, "Value of xflag inside:", xflag                                            
C          PRINT *, "Value of a inside:", a                                                    
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCC  XEM CASE   CCCCCCCCCCCCCCCCCCCCCCCCCCCCCC


C	if((xflag.eq.1).or.(xflag.eq.2)) then
C	   if(a.gt.1.5) then
C	      call target_info(0.0,dum0,dum1,dum2,z,a,dum3,dum4,aux,dum5)
C	      write(6,*)  'before ', e1cc,e2cc,th,a,z,m_tgt,aux,sig_qe,y,fact
C	      call f_to_sig(e1cc,e2cc,th,a,z,m_tgt,aux,sig_qe,y,fact)
C	      write(6,*)  'after ', e1cc,e2cc,th,a,z,m_tgt,aux,sig_qe,y,fact
C	   else
C	      sig_qe=0.0
CCC	      PRINT *, "Defaulting to zero!: ", sig_qe
C	   endif
CCC	   sig_qe = sig_qe*ff1**2  ! added by smoran
C	endif
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
	...
	write(6,*) 'sig, sig_qe, sig_dis :', sig , sig_qe, sig_dis

CC       DG this is no longer needed.
Cc	sig = sig*1000.0 !to be consistent with Peter's units

Cc	write(6,*) 'leaving sigmodel_calc_2013'
