...
C ============================ Executable Code =================================
	write(6,*) 'f_to_sig: ' ,e1,e2,theta,a,z,m1,aux,sig,y,fact
...
!- rewritten starting here--------------------------------------
	...
	write (6,*) 'after y_calc: ' ,y,y_calc_ok
...
900	continue 
	write(6,*) 'f_to_sig FINAL: ' ,e1,e2,theta,a,z,m1,aux,sig,y,fact
	return
	end
